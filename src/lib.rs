...
mod test {
    ...
    fn test_lambert_w_0() {
        ...
        assert_ulps_eq!(lambert_w_0(-2.678794411714424e-01), -3.993824525397807e-01);
        assert_ulps_eq!(lambert_w_0(6.321205588285577e-01), 4.167039988177658e-01);
        assert_ulps_eq!(lambert_w_0(9.632120558828557), 1.721757710976171);
        assert_ulps_eq!(lambert_w_0(9.963212055882856e+01), 3.382785211058958);
        assert_ulps_eq!(lambert_w_0(9.996321205588285e+02), 5.249293782013269);
        assert_ulps_eq!(
            lambert_w_0(9.999632120558828e+03),
            7.231813718542178,
            epsilon = 1e-14
        );
        assert_ulps_eq!(lambert_w_0(9.999963212055883e+04), 9.284568107521959);
        assert_ulps_eq!(lambert_w_0(9.999996321205589e+05), 1.138335774796812e+01);
        assert_ulps_eq!(lambert_w_0(9.999999632120559e+06), 1.351434397605273e+01);
        assert_ulps_eq!(
        ...
        assert_ulps_eq!(lambert_w_0(9.999999999963213e+10), 2.222712273495755e+01);
        assert_ulps_eq!(
        ...
        assert_ulps_eq!(lambert_w_0(1.000000000000000e+17), 3.557237716651325e+01);
        assert_ulps_eq!(
        ...
        assert_ulps_eq!(lambert_w_0(1.000000000000000e+20), 4.230675509173839e+01);
        assert_ulps_eq!(lambert_w_0(1.000000000000000e+40), 8.763027715194720e+01);
        assert_ulps_eq!(
        ...
        assert_ulps_eq!(lambert_w_0(1.000000000000000e+160), 3.625205337614976e+02);
    }
    ...
    fn test_lambert_w_m1() {
        ...
        assert_ulps_eq!(lambert_w_m1(-1.000000000000000e-01), -3.577152063957297);
        assert_ulps_eq!(lambert_w_m1(-3.000000000000000e-02), -5.144482721515681);
        assert_ulps_eq!(
